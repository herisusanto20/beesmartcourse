...
<head>
    <title>Laporan Data Registrasi SMA</title>
...
<body>
    <h1 class="h1laporan">Laporan Data Registrasi SMA</h1>
<?php
    $hostname = 'localhost';
    $username = 'root';
    $password = '';
...
?>
    <div class="container mt-4">
        ...
        <form action="laporan_data.php?cetak=1" method="get">
...
if(isset($_GET['cetak'])) {
    ...
    header("Content-Disposition: attachment; filename=laporan_datasma.xls");
}

                        //jika tanggal dari dan tanggal ke ada maka
                        if(isset($_GET['dari']) && isset($_GET['ke'])){
                            // tampilkan data yang sesuai dengan range tanggal yang dicari 
                            $data = mysqli_query($conn, "SELECT * FROM tb_data WHERE tanggal BETWEEN '".$_GET['dari']."' AND '".$_GET['ke']."' ORDER BY tanggal ASC");
                        }else{
                            //jika tidak ada tanggal dari dan tanggal ke maka tampilkan seluruh data
                            $data = mysqli_query($conn, "SELECT * FROM tb_data ORDER BY tanggal ASC");
                        }
                    ...
                    <tr>
                        ...
                        <td><?php echo $d['jenis_kursus']; ?></td>
                        <td><?php echo $d['statussma']; ?></td>
        ...
        <a href="laporan_data.php?cetak=1&dari=<?php echo $_GET['dari']; ?>&ke=<?php echo $_GET['ke']; ?>"><button class="buttonn">Download</button></a>
        <a href="laporan_data.php"><button class="buttonn">Kembali Ke data semula</button></a>
