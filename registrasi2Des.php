...
<head>
    ...
    <title>Pendaftaran Desain Grafis Reguler</title>
                <!-- Fonts -->
...
$sisaKuotaDesain = 5; // Contoh nilai awal, bisa diganti sesuai kebutuhan
$sisaKuotaDesain1 = 3; // Contoh nilai awal, bisa diganti sesuai kebutuhan

// ...
?>
                        <select name="jeniskursussmp" class="input-controll" required>
    <optgroup label="Jenis Kursus">
        <option <?php echo ($sisaKuotaDesain > 5) ? 'disabled' : ''; ?>>Reguler</option>
    </optgroup>
</select>
