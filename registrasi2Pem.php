...
<head>
    ...
    <title>Pendaftaran Pemrograman Reguler</title>
                <!-- Fonts -->
...
$sisaKuotaPem = 5; // Contoh nilai awal, bisa diganti sesuai kebutuhan
$sisaKuotaPem1 = 3; // Contoh nilai awal, bisa diganti sesuai kebutuhan

// ...
?>
                        <select name="jeniskursussmp" class="input-controll" required>
    <optgroup label="Jenis Kursus">
        <option <?php echo ($sisaKuotaPem > 5) ? 'disabled' : ''; ?>>Reguler</option>
    </optgroup>
</select>
