...
<body>
            ...
            <div class="navbar-nav">
                ...
                <a href="data-siswa-uswatun.php">Data Registrasi</a>
            </div>
        ...
        <select  name="jadwal" id="jadwal" class="jadwal" required>
                       ...
                       <?php
                        ...
                        if(isset($_POST['prosess'])) {
                            mysqli_query($conn, "insert into uswatun_form set
                            nama = '$_POST[nama]',
                            jadwal = '$_POST[jadwal]',
                            ...
                            echo "<meta http-equiv=refresh content=1;URL='data-siswa-uswatun.php'>";
                        }
                        ?>
                </div>
            </div>
