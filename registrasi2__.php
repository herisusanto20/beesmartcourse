...
<head>
    ...
    <title>Pendaftaran IPA Reguler</title>
                <!-- Fonts -->
...
$sisaKuotaIPA = 5; // Contoh nilai awal, bisa diganti sesuai kebutuhan
$sisaKuotaIPA1 = 3; // Contoh nilai awal, bisa diganti sesuai kebutuhan

// ...
?>
                        <select name="jeniskursussmp" class="input-controll" required>
    <optgroup label="Jenis Kursus">
        <option <?php echo ($sisaKuotaIPA > 5) ? 'disabled' : ''; ?>>Reguler</option>
    </optgroup>
</select>
